...
import { MoneyContext, TransactionsContext } from '../../context/allcontext';
//contexts
...
const TransactionBar = props => {
    ...
    return (
        <div className='TransactionBar'>
            ...
            <Button  buttonSize="smallButton" background="backgroundRed" clickFunction={deleteTransaction}/>
            <Button  buttonSize="smallButton" background="backgroundOrange" clickFunction={toggleModal} />
            {modalOn ? 
                <Modal 
